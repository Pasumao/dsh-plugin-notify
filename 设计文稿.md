...
```
C:\Users\18303\Desktop\dsh-plugin-notice\
├── package.json            # @dsh-external/dsh-plugin-notice；main: lib/index.js
...
1. `package.json` dependencies 加 `"@dsh-external/dsh-plugin-notice": "link:C:/Users/18303/Desktop/dsh-plugin-notice"`。
2. profile 目录 `pnpm install`。
3. `cordis.patch.yml` 追加 `- insert: [{ id: dsh-plugin-notice, name: '@dsh-external/dsh-plugin-notice', config: { cooldownMs: 10000 } }]`。
